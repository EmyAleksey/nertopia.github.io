...
<body>
    ...
    <center>
        <br>
        <h1>Listagem de bonecos</h1>
        <br>
        <br>
        <a href="bonecos_formulario.php" class="btn btn-primary" role="button">Cadastrar bonecos</a>
    </center>
...
<?php
        while($row = $result->fetch_assoc()) {
            ...
            echo "<td><a href=\"bonecos_exclui.php?id=". $row["id"] ."\">Excluir</a></td>";
            echo "</tr>";
        }
?>
